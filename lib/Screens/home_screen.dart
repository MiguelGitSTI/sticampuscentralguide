    ...
    _tabs = [
      _HomeTab(
        ...
        onLocateRequest: (String buildingId) {
          ...
          try {
            st?.highlightBuilding(buildingId);
          } catch (_) {}
          _onTabChanged(1);
        },
      ),
...
class _HomeTabState extends State<_HomeTab> {
  final GlobalKey<ProfileButtonState> _profileButtonKey =
      GlobalKey<ProfileButtonState>();
  final GlobalKey<NotificationButtonWithBadgeState> _notificationButtonKey =
      GlobalKey<NotificationButtonWithBadgeState>();
                  ...
                  Expanded(
                    child: LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final btnHpad = shortScreen
                            ? buttonHPad * 0.9
                            : buttonHPad;
                        final btnVpad = shortScreen
                            ? math.max(10.0, buttonVPad * 0.9)
                            : buttonVPad;
                        final btnFont = shortScreen
                            ? math.max(16.0, buttonFont - 2)
                            : buttonFont;
                        return Column(
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Center(
                                child: Image.asset(
                                  'assets/images/app/icon_complete.webp',
                                  height: imgH,
                                  fit: BoxFit.contain,
                                ),
                              ),
